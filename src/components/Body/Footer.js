...
import { Grid,Toolbar,Typography, styled, Box, Link } from '@mui/material';
  ...
  return (
    ...
    <AppBox style={{width:'91%'}}>
      ...
      <Box sx={{ display: 'flex', gap: '20px'}}>
        <a href="https://play.google.com/store/apps/details?id=in.swiggy.android&hl=en&gl=US"><img style={{objectFit:'contain'}} src={appStore} alt=""/></a>
      </Box>
    </AppBox>
